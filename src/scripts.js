...
function Poem(event) {
  ...
  let context = `You are a poem AI assistant. Please provide an 8 line poem using basic HTML with each line seperated by a <br />. Please make sure the poem rhymes. Please sign the poem '- SheCodes AI' at the end of the poem, inside a <strong> element.`;
